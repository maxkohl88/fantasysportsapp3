class DailyPlayerResult < ActiveRecord::Base
  ...
  COUNTING_STATS = %i(games_played minutes_played field_goals_made field_goals_attempted free_throws_made free_throws_attempted rebounds assists steals blocks turnovers points)
